...
jQuery.fn.bxSlider = function(options) {
    ...
    function fade(direction) {
        ...
        if (k == last_before_switch) {
            ...
            $this.children().eq(k).fadeTo(options.speed, 0, function() {
                $(this).hide();
            });
    ...
    function add_controls() {
        ...
        if (options.prev_img != '' || options.next_img != '') {
            ...
            $this.parent().append('<a class="slider_prev" href=""><img src="../casting_products_files/' + options.prev_img + '" alt=""/></a><a class="slider_next" href=""><img src="../casting_products_files/' + options.next_img + '" alt="" /></a>');
